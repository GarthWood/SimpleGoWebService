...
func (m *MockCartWriter) WriteCart(cart *model.Cart) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteCart", cart)
	ret0, _ := ret[0].(error)
	return ret0
}

// WriteCart indicates an expected call of WriteCart
func (mr *MockCartWriterMockRecorder) WriteCart(cart interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteCart", reflect.TypeOf((*MockCartWriter)(nil).WriteCart), cart)
}
